...
const bool VeinsInetSampleMessage::getIsTrusted() const
{
    return this->vehicleIsTrusted;
}

void VeinsInetSampleMessage::setIsTrusted(const bool isTrusted)
{
    this->vehicleIsTrusted = isTrusted;
}
